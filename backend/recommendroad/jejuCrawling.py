...
DATA_DIR = "../data"
DATA_FILE = os.path.join(DATA_DIR, "jejustore.json")
DUMP_FILE = os.path.join(DATA_DIR, "jejustore.pkl")
...
def search_selenium(data_path=DATA_FILE) :
    ...
    for d in data:
        ...
        image.screenshot("c:/expression/" + str(d['sid'])+ ".png")
        # print("찰칵" + d['sid'] + "저장")
        browser.close()
